                ...
                if (list[k].ServerName == row.cells[0].textContent) {
                    ...
                    if (thisDate >= list[k].StartDate) {
                        if ((list[k].EndDate == -7200) || thisDate <= new Date(list[k].EndDate)) {
                            ...
                            /* adaug celula cu tipul incidentului */
                            var type;
                            ...
                            /* adaug celula cu descrierea incidentului*/
                            ...
                            /* adaug celula cu actiunea de delete*/
                            ...
                            deleteButton.href = "#";
                            deleteButton.id = "delete" + String(k * 10000 + i * 100 + j);
                            ...
                            $(document).ready(function () {
                                $(document).on("click", `#delete${(k * 10000 + i * 100 + j)}`, function () {
                                    $(this).parents(".popover").popover('hide');
                                    if ($('#sessionAccess').text() == '2') {
